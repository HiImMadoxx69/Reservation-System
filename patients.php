...
<html lang="en">
  ...
  <div class="site-block-3" style="margin: 80px 80px;padding-top: 0px;padding-bottom: 0px; margin-top: 0px; margin-bottom: 0px;">
       <nav class="navbar" style="padding-top: 0px;padding-bottom: 0px;margin-top: 0px; margin-bottom: 0px;">
    ...
    echo'  <li class="item">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="'.$img.'" style ="width:50px;height;50px">
        ...
        <div class="row">
          <div class="col-md-6 pr-md-5 text-left mb-5">
            <div class="mb-5">
              ...
              <p class="lead"><em>&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus doloremque totam repudiandae dolor dolores tenetur, porro unde cumque ullam quaerat quo officia. Autem ea, a vel quibusdam provident deserunt placeat.</p>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus doloremque totam repudiandae dolor dolores tenetur, porro unde cumque ullam quaerat quo officia. Autem ea, a vel quibusdam provident deserunt placeat.&rdquo;</em></p>
              <div class="mt-5 mb-3">
          ...
          <div class="col-md-6 pr-md-5 text-left mb-5">
            <div class="mb-5">
              <img src="images/person_2.jpg" alt="Image" class="w-50 mb-5 rounded-circle">
              <p class="lead"><em>&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus doloremque totam repudiandae dolor dolores tenetur, porro unde cumque ullam quaerat quo officia. Autem ea, a vel quibusdam provident deserunt placeat.</p>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus doloremque totam repudiandae dolor dolores tenetur, porro unde cumque ullam quaerat quo officia. Autem ea, a vel quibusdam provident deserunt placeat.&rdquo;</em></p>
              <div class="mt-5 mb-3">
                <span class="icon-star text-warning"></span>
          ...
          <div class="col-md-6 pl-md-5 text-left">
            <div>
              <img src="images/person_4.jpg" alt="Image" class="w-50 mb-5 rounded-circle">
              <p class="lead"><em>&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus doloremque totam repudiandae dolor dolores tenetur, porro unde cumque ullam quaerat quo officia. Autem ea, a vel quibusdam provident deserunt placeat.</p>
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minus doloremque totam repudiandae dolor dolores tenetur, porro unde cumque ullam quaerat quo officia. Autem ea, a vel quibusdam provident deserunt placeat.&rdquo;</em></p>
              <div class="mt-5 mb-3">
                <span class="icon-star text-warning"></span>
