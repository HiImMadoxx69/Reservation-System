...
if(isset($_POST['submit'])){
 ...
 if($pass1 == $pass2 && $pass1!=null){
  ...
  $sql = "UPDATE `tblloginuser` SET `firstname` = '$fname', `lastname` = '$lname', `contact` = '$contact', `username` = '$username', `password` = '$pass' WHERE `tblloginuser`.`ID` = '$id';";
$result = mysqli_query($con, $sql);
echo '<script>alert("Data Successfully Updated!");';
     echo 'window.location.replace("viewuseraccount.php");</script>';
   }
   else{
 $sql = "UPDATE `tblloginuser` SET `firstname` = '$fname', `lastname` = '$lname', `contact` = '$contact', `username` = '$username' WHERE `tblloginuser`.`ID` = '$id';";
$result = mysqli_query($con, $sql);
echo '<script>alert("Data Successfully Updated!");';
     echo 'window.location.replace("viewuseraccount.php");</script>';
}
