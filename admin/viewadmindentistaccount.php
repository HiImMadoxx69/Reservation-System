                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">View User Accounts<br><form method="POST" action="addadmindentistaccount.php"><br><button class="btn-success">ADD</button></form></h6>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                   <?php 
                            $sql = "SELECT * FROM tblloginuser WHERE Access='admin' OR Access='dentist'";
                   ...
                   ?>
                                        <tr>
                                           ...
                                           <td ><a  class="btn btn-success btn-sm" href="editadmindentisaccount.php?ID=<?php echo $row['ID'];?>">EDIT</a>&nbsp;
