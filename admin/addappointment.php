...
if(isset($_POST['submit'])){
 ...
 $sql = "INSERT INTO `tblappointment` (`firstname`, `lastname`, `contact`, `email`, `clinic`, `date`, `time`, `service`, `status`) VALUES ('$firstname', '$lastname', '$contact', '$email', '$clinic', '$date', '$time', '$service', '$status');";
...
if ($result) {
   echo '<script>alert("Data Successfully Added!");';
     echo 'window.location.replace("viewappointment.php");</script>';
}
else
{
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">ADD Shedule Appointment</h6>
                        </div>
                    ...
                    <div class="row cont-row">
                        ...
                        <div class="col-sm-8"><input style="width: 300px;" type="text" name="firstname"id="firstname" placeholder="First Name" name="name" class="form-control input-sm"></div>
                    </div>
                    <div class="row cont-row">
                        <div class="col-sm-3"><label>Last Name</label><span>:</span></div>
                        <div class="col-sm-8"><input style="width: 300px;"tstyle="width: 300px;"ype="text" name="lastname"id="lastname" placeholder="Last name" class="form-control input-sm"></div>
                    </div>
                    <div class="row cont-row">
                    ...
                    <div class="row cont-row">
                        ...
                        <div class="col-sm-8"><input style="width: 300px;" type="email" name="email" id="email" placeholder="Enter Email" class="form-control input-sm"></div>
                    </div>
                    <div class="row cont-row">
                        <div class="col-sm-3"><label>Date</label><span>:</span></div>
                        <div class="col-sm-8"><input  style="width: 300px;"type="date"class="form-control input-sm" id="date" name="date" id="date"></div>
...
document.getElementById("date").setAttribute('min', minDate)
    console.log(minDate);
                       ...
                       <div class="row cont-row">
                                   ...
                                   <div class="col-sm-3"><label for="services"><span>Clinic:</span></label></div>
                                   <br>  <br>
                                     <div class="col-sm-8"> <select style="width: 300px;" class="form-control input-sm" name="clinic" id="clinic">
                     ...
                     <div class="row cont-row">
                                   ...
                                   <div class="col-sm-3"><label for="services"><span>Time:</span></label>     </div>
                                  
                                      <div class="col-sm-8"><select style="width: 300px;" class="form-control input-sm" name="time" id="time">
                                        <option value="10:30 AM">10:30 AM</option>
                                        <option value="11:30 AM">11:30 AM</option>
                                        <option value="1:00 PM">1:00 PM</option>
                                         <option value="10:30 AM">1:30 PM</option>
                                        <option value="11:30 AM">2:00 AM</option>
                                        <option value="1:00 PM">2:30 PM</option>
                                         <option value="10:30 AM">3:00 AM</option>
                                        <option value="11:30 AM">3:30 AM</option>
                                        <option value="1:00 PM">4:00 PM</option>
                                        <option value="1:00 PM">4:30 PM</option>
                                      </select></div>
     ...
     <div class="form-check">
      ...
      <label>Cosmetic Dentistry 
                       ...
                       <div class="row cont-row">
                                   ...
                                   <div class="col-sm-3"><label for="services"><span>Status:</span></label>     </div>
                                 
                                       <div class="col-sm-8"><select style="width: 300px;" class="form-control input-sm" name="status" id="status">
