...
if ($result) {
     ...
     echo 'window.location.replace("archiveuseraccount.php");</script>';
 }
else
{
    ...
    <div class="modal-dialog modal-confirm">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
               <a class="btn btn-secondary" href="viewappointment.php" style="color:white;">Cancel</a>
               <form method="POST" action=""><button type="submit" id="delete" name="delete" class="btn btn-danger">Delete</button></form> 
            </div>
        </div>
    </div> 
</body>
